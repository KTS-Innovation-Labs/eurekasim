...
#include "stdafx.h"
#include "PlusTwoPhysicsExperiment.h"
...
CPlusTwoPhysicsExperiment::CPlusTwoPhysicsExperiment(CAddinSimulationManager* pManager)
{
	m_pManager = pManager;
}

CPlusTwoPhysicsExperiment::~CPlusTwoPhysicsExperiment()
{
}

void CPlusTwoPhysicsExperiment::LoadAllExperiments()
{
	...
	ExperimentTreeView->SetRootNodeName(CString(CPP_SAMPLE_EXPERIMENT_TYPE_PLUS_TWO_PROPERTIES).AllocSysString(), TRUE);
...
void CPlusTwoPhysicsExperiment::OnTreeNodeSelect(BSTR ExperimentGroup, BSTR ExperimentName)
{
	OnReloadExperiment(ExperimentGroup, ExperimentName);
}
void CPlusTwoPhysicsExperiment::OnTreeNodeDblClick(BSTR ExperimentGroup, BSTR ExperimentName)
{
...
void CPlusTwoPhysicsExperiment::OnReloadExperiment(BSTR ExperimentGroup, BSTR ExperimentName)
{
...
void CPlusTwoPhysicsExperiment::ShowObjectProperties()
{
#if TRUE
...
void CPlusTwoPhysicsExperiment::Serialize(CArchive& ar)
{
	if (ar.IsStoring())
	{
...
void CPlusTwoPhysicsExperiment::OnPropertyChanged(BSTR GroupName, BSTR PropertyName, BSTR PropertyValue)
{
...
void CPlusTwoPhysicsExperiment::DrawCube()
{
...
void CPlusTwoPhysicsExperiment::DrawBall()
{
...
void CPlusTwoPhysicsExperiment::DrawPyramid()
{
	CComPtr<IApplicationView> ApplicationView;
	HRESULT HR = ApplicationView.CoCreateInstance(CLSID_ApplicationView);
	if (FAILED(HR))
...
void CPlusTwoPhysicsExperiment::DrawAeroplane()
{
	CComPtr<IApplicationView> ApplicationView;
	HRESULT HR = ApplicationView.CoCreateInstance(CLSID_ApplicationView);
	if (FAILED(HR))
...
void CPlusTwoPhysicsExperiment::StartSimulation(BSTR ExperimentGroup, BSTR ExperimentName)
{
...
void CPlusTwoPhysicsExperiment::StartObjectSimulation()
{
...
void CPlusTwoPhysicsExperiment::OnNextSimulationPoint(float Angle, float x, float y, float z)
{
	CString strStatus;
...
void CPlusTwoPhysicsExperiment::PlotSimulationPoint(float Angle, float x, float y, float z)
{
...
void CPlusTwoPhysicsExperiment::InitializeSimulationGraph(CString ExperimentName)
{
...
void CPlusTwoPhysicsExperiment::DisplayObjectDemoGraph()
{
