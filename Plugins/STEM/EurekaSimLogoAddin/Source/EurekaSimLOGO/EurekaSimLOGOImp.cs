...
namespace EurekaSimLOGO
{
    ...
    [Guid("D4A636CD-9F16-4904-8797-AAF2210C75A2")]

    public class EurekaSimLOGOImp : EurekaSim.Net.Addin,
        ...
        IFileSettingsTreeViewEvents
    {
        ...
        public void Initialize(int lSessionID, MainApplication pApp, object bFirstTime)
        {
            ...
            Stream rgbxml = thisAssembly.GetManifestResourceStream("EurekaSimLOGO.AddinRibbon.xml");

            Stream rgbBmp = thisAssembly.GetManifestResourceStream("EurekaSimLOGO.toolbar1.bmp");
