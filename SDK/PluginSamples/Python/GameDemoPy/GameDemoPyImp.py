...
#   GameDemoPyImp.py --unregister
#
# To debug, execute:
#   GameDemoPyImp.py --debug
#
...
class GameDemoPyImp():
    ...
    _reg_clsid_ = "{4e3404c1-3cc8-4527-b59b-d1136245055e}"
    _reg_progid_ = "GameDemoPyImp"
...
if __name__ == '__main__':
    ...
    win32com.server.register.UseCommandLine(GameDemoPyImp)
    if "--unregister" in sys.argv:
        UnregisterAddin(GameDemoPyImp)
    else:
        RegisterAddin(GameDemoPyImp)
