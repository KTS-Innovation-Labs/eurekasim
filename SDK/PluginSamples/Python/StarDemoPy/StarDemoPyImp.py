...
#   StarDemoPyImp.py --unregister
#
# To debug, execute:
#   StarDemoPyImp.py --debug
#
...
class StarDemoPyImp():
    ...
    _reg_clsid_ = "{7af16ca5-6cd5-4da5-a91f-015a08108767}"
    _reg_progid_ = "StarDemoPyImp"
...
if __name__ == '__main__':
    ...
    win32com.server.register.UseCommandLine(StarDemoPyImp)
    if "--unregister" in sys.argv:
        UnregisterAddin(StarDemoPyImp)
    else:
        RegisterAddin(StarDemoPyImp)
