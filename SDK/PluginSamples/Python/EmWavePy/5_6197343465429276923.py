...
#   EmWavePyImp.py --unregister
#
# To debug, execute:
#   EmWavePyImp.py --debug
#
...
class EmWavePyImp():
    ...
    _reg_clsid_ = "{6d68ea0f-a042-4d81-88dd-b91b06407a23}"
    _reg_progid_ = "EmWavePyImp"
    ...
    def Initialize(self, lSessionID, pApp, bFirstTime):
        try:
            # Get the directory of the current script. __file__ might be lowercase from the host app.
            module_path = os.path.abspath(os.path.dirname(__file__))
            # Use win32api to get the actual case-sensitive path from the filesystem. This fixes the issue.
            my_path = win32api.GetLongPathName(module_path)
...
if __name__ == '__main__':
    ...
    win32com.server.register.UseCommandLine(EmWavePyImp)
    if "--unregister" in sys.argv:
        UnregisterAddin(EmWavePyImp)
    else:
        RegisterAddin(EmWavePyImp)