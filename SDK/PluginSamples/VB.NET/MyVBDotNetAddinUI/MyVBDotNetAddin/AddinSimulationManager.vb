...
Namespace MyVbDotNetAddin
    ...
    Public Class AddinSimulationManager
        ...
        Public m_strExperimentType As String
        ...
        Public Sub OnStartSimulation(ByVal ExperimentName As String)
            If Not IsAddinExperimentSelected() OrElse String.IsNullOrEmpty(m_strExperimentType) Then
            ...
            If m_strExperimentType = Constants.CS_SAMPLE_EXPERIMENT_TYPE_GROUP_1 Then
        ...
        Public Sub LoadExperiments(ByVal ExperimentType As String)
            If Not IsAddinExperimentSelected() Then
                Return
            End If

            If ExperimentType = Constants.CS_SAMPLE_EXPERIMENT_TYPE_GROUP_1 Then
                m_pObjectDemoExperiment.LoadAllExperiments()
            End If
