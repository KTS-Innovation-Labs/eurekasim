...
#Region "IAddin"
        Public Sub Initialize(ByVal lSessionID As Integer, ByVal pApp As MainApplication, ByVal bFirstTime As Object) Implements EurekaSim.Net.IAddin.Initialize
            ...
            experiment.AddExperiment(lSessionID, Constants.VB_SAMPLE_MAIN_EXPERIMENT_NAME)
...
#Region "IFileSettingsTreeViewEvents"
        ...
        End Sub
#End Region
        Public Sub SetRibbonControlText(ByVal ID As String, ByVal Text As String)
            Dim ObjRibbonToolbar = New RibbonToolbar()
            ObjRibbonToolbar.SetControlText(ID, Text)
        End Sub
    End Class
End Namespace
