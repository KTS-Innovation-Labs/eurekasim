...
class ATL_NO_VTABLE CTowerOfHanoiSimulation :
	public CComObjectRootEx<CComSingleThreadModel>,
	public CComCoClass<CTowerOfHanoiSimulation, &CLSID_TowerOfHanoiSimulation>,
	public IDispatchImpl<ITowerOfHanoiSimulation, &IID_ITowerOfHanoiSimulation, &LIBID_TowerOfHanoiLib, /*wMajor =*/ 1, /*wMinor =*/ 0>,
...
public:
	...
	BEGIN_COM_MAP(CTowerOfHanoiSimulation)
		COM_INTERFACE_ENTRY(ITowerOfHanoiSimulation)
		COM_INTERFACE_ENTRY2(IDispatch, ITowerOfHanoiSimulation)
...
public:
	...
	STDMETHOD(OnNumRingsChange)(BSTR CtrlID, long Index);
	STDMETHOD(OnSpeedChange)(BSTR CtrlID, long Index);
...
public:
	...
	{
		return m_pAddinSimulationManager->OnStartSimulation(ExperimentName);
	}
	STDMETHOD(OnStopSimulation)(BSTR ExperimentName)
	{
		return m_pAddinSimulationManager->OnStopSimulation(ExperimentName);
	}
...
OBJECT_ENTRY_AUTO(__uuidof(TowerOfHanoiSimulation), CTowerOfHanoiSimulation)