...
#define CPP_SAMPLE_MAIN_EXPERIMENT_NAME								_T("TowerOfHanoi Experiment Simulation Demo")
...
public:
	...
	CTowerOfHanoiSimulation*				m_pAddin;
	...
	CAddinSimulationManager(CTowerOfHanoiSimulation* pAddin);
