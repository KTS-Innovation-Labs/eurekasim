...
#define CPP_SAMPLE_MAIN_EXPERIMENT_NAME								_T("StarDemo Experiment Simulation Demo")
...
public:
	...
	CAddinSimulationManager(CStarDemoSimulation* pAddin);
