...
BOOL CStarDemoSimulation::LoadLongResource(CString &str, UINT nID)
{
	try
	{
		HRSRC               hRes;
...
STDMETHODIMP CStarDemoSimulation::InvokePreferenceSettings()
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState());

	AfxMessageBox(_T("CStarDemoSimulation::InvokePreferenceSettings()"));

	return S_OK;
}


STDMETHODIMP CStarDemoSimulation::InvokeDefaultSettings()
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState());

	AfxMessageBox(_T("CStarDemoSimulation::InvokeDefaultSettings(Hai)"));

	return S_OK;
}


STDMETHODIMP CStarDemoSimulation::InvokeOnExperimentChanged()
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState());
	return S_OK;
...
void CStarDemoSimulation::SetRibbonControlText(CString ID, CString Text)
{
...
void CStarDemoSimulation::LoadAddinName(CString strXML)
{
	try
	{
		USES_CONVERSION;
