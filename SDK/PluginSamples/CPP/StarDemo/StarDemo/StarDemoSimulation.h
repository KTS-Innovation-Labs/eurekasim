...
class ATL_NO_VTABLE CStarDemoSimulation :
	public CComObjectRootEx<CComSingleThreadModel>,
	public CComCoClass<CStarDemoSimulation, &CLSID_StarDemoSimulation>,
	public IDispatchImpl<IStarDemoSimulation, &IID_IStarDemoSimulation, &LIBID_StarDemoLib, /*wMajor =*/ 1, /*wMinor =*/ 0>,
...
public:
	...
	BEGIN_COM_MAP(CStarDemoSimulation)
		COM_INTERFACE_ENTRY(IStarDemoSimulation)
		COM_INTERFACE_ENTRY2(IDispatch, IStarDemoSimulation)
...
OBJECT_ENTRY_AUTO(__uuidof(StarDemoSimulation), CStarDemoSimulation)
