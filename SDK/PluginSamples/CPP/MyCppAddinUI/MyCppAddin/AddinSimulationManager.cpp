...
CAddinSimulationManager::CAddinSimulationManager(CMyCppAddinSimulation* pAddin)
{
	...
	m_strExperimentType = CPP_SAMPLE_EXPERIMENT_TYPE_GROUP_1;
...
void CAddinSimulationManager::LoadExperiments(CString ExperimentType)
{
	...
	if (ExperimentType == CPP_SAMPLE_EXPERIMENT_TYPE_GROUP_1)
	{
...
void CAddinSimulationManager::OnStatusChange(long StatusCode, BSTR StatusDesc, BSTR AdditionalParam)
{
	...
	{
		if (m_strExperimentType == CPP_SAMPLE_EXPERIMENT_TYPE_GROUP_1)
		{
			m_pObjectDemoExperiment->LoadAllExperiments();
