...
#define CPP_SAMPLE_MAIN_EXPERIMENT_NAME								_T("MyCppAddin Experiment Simulation Demo")


#define CPP_SAMPLE_EXPERIMENT_TYPE_GROUP_1							_T("Experiment Group 1")
...
public:
	...
	CMyCppAddinSimulation*						m_pAddin;
	...
	CAddinSimulationManager(CMyCppAddinSimulation* pAddin);
