...
#define OBJECT_TYPES								_T("Cube,Ball,Pyramid,Aeroplane,Clock,Dice,Banner Cube")
...
#define OBJECT_TYPE_BANNER                           _T("Banner Cube")
...
public:
	...
	unsigned int LoadTexture(UINT resourceId,ULONG textureID);
