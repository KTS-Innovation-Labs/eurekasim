...
BOOL CCubeCPPAddinSimulation::LoadLongResource(CString &str, UINT nID)
{
	try
	{
		HRSRC               hRes;
...
STDMETHODIMP CCubeCPPAddinSimulation::InvokePreferenceSettings()
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState());

	AfxMessageBox(_T("CCubeCPPAddinSimulation::InvokePreferenceSettings()"));

	return S_OK;
}


STDMETHODIMP CCubeCPPAddinSimulation::InvokeDefaultSettings()
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState());

	AfxMessageBox(_T("CCubeCPPAddinSimulation::InvokeDefaultSettings(Hai)"));

	return S_OK;
}


STDMETHODIMP CCubeCPPAddinSimulation::InvokeOnExperimentChanged()
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState());
	return S_OK;
...
void CCubeCPPAddinSimulation::SetRibbonControlText(CString ID, CString Text)
{
...
void CCubeCPPAddinSimulation::LoadAddinName(CString strXML)
{
	try
	{
		USES_CONVERSION;
