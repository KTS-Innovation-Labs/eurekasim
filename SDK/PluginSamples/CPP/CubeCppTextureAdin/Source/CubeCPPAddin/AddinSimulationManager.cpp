...
CAddinSimulationManager::CAddinSimulationManager(CCubeCPPAddinSimulation* pAddin)
{
	m_pAddin = pAddin;
...
{
	/*if (m_pObjectDemoExperiment->m_ObjectPattern.m_strObjectType == OBJECT_TYPE_TEST)
	{
		m_pObjectDemoExperiment->TestDice();
	}*/
}
