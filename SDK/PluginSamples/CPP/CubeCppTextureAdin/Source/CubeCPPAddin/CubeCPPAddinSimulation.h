...
class ATL_NO_VTABLE CCubeCPPAddinSimulation :
	public CComObjectRootEx<CComSingleThreadModel>,
	public CComCoClass<CCubeCPPAddinSimulation, &CLSID_CubeCPPAddinSimulation>,
	public IDispatchImpl<ICubeCPPAddinSimulation, &IID_ICubeCPPAddinSimulation, &LIBID_CubeCPPAddinLib, /*wMajor =*/ 1, /*wMinor =*/ 0>,
...
public:
	...
	BEGIN_COM_MAP(CCubeCPPAddinSimulation)
		COM_INTERFACE_ENTRY(ICubeCPPAddinSimulation)
		COM_INTERFACE_ENTRY2(IDispatch, ICubeCPPAddinSimulation)
...
OBJECT_ENTRY_AUTO(__uuidof(CubeCPPAddinSimulation), CCubeCPPAddinSimulation)
