...
#define CPP_SAMPLE_MAIN_EXPERIMENT_NAME								_T("CubeCPPAddin Experiment Simulation Demo")
...
public:
	...
	CCubeCPPAddinSimulation*						m_pAddin;
	...
	CAddinSimulationManager(CCubeCPPAddinSimulation* pAddin);
