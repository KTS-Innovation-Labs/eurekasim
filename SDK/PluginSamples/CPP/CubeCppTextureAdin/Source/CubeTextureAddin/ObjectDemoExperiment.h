...
#define OBJECT_TYPES								_T("Cube,Ball,Pyramid,Aeroplane,Clock,BannerCube,Dice")
...
#define OBJECT_TYPE_BANNER_CUBE						_T("BannerCube")
#define OBJECT_TYPE_DICE							_T("Dice")
...
class CObjectDemoExperiment : public CObject
{
	...
	unsigned int					m_bottomId;
	unsigned int					m_rightId;
	unsigned int					m_leftId;

	HBITMAP							hBanner;
	VARIANT							BitmapData;
	unsigned int LoadTexture(UINT resourceId);
	void DrawFrontFaceCube(ULONG textureID);
	void DrawBackFaceCube(ULONG textureID);
	void DrawTopFaceCube(ULONG textureID);
	void DrawBottomFaceCube(ULONG textureID);
	void DrawLeftFaceCube(ULONG textureID);
	void DrawRightFaceCube(ULONG textureID);
