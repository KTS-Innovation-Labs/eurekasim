...
class ATL_NO_VTABLE CCubeTextureAddinSimulation :
	public CComObjectRootEx<CComSingleThreadModel>,
	public CComCoClass<CCubeTextureAddinSimulation, &CLSID_CubeTextureAddinSimulation>,
	public IDispatchImpl<ICubeTextureAddinSimulation, &IID_ICubeTextureAddinSimulation, &LIBID_CubeTextureAddinLib, /*wMajor =*/ 1, /*wMinor =*/ 0>,
...
public:
	...
	BEGIN_COM_MAP(CCubeTextureAddinSimulation)
		COM_INTERFACE_ENTRY(ICubeTextureAddinSimulation)
		COM_INTERFACE_ENTRY2(IDispatch, ICubeTextureAddinSimulation)
...
OBJECT_ENTRY_AUTO(__uuidof(CubeTextureAddinSimulation), CCubeTextureAddinSimulation)
