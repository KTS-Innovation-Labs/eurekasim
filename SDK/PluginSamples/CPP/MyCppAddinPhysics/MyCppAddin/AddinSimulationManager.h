...
#define CPP_SAMPLE_MAIN_EXPERIMENT_NAME								_T("Academic Lab Experiment Simulation")


#define CPP_SAMPLE_EXPERIMENT_TYPE_PLUS_TWO							_T("Plus Two Physics Experiment")
#define CPP_SAMPLE_EXPERIMENT_TYPE_BSC								_T("B.Sc Physics Experiment")
#define CPP_SAMPLE_EXPERIMENT_TYPE_MSC								_T("M.Sc Physics Experiment")

#define CPP_SAMPLE_EXPERIMENT_TYPE_PLUS_TWO_PROPERTIES				_T("Plus Two Physics Experiment Properties")
#define CPP_SAMPLE_EXPERIMENT_TYPE_BSC_PROPERTIES					_T("B.Sc Physics Experiment Properties")
#define CPP_SAMPLE_EXPERIMENT_TYPE_MSC_PROPERTIES					_T("M.Sc Physics Experiment Properties")
...
public:
	...
	CMySimulationAddin*						m_pAddin;
	CPlusTwoPhysicsExperiment*				m_pPlusTwoPhysicsExperiment;
	CBScPhysicsExperiment*					m_pBScPhysicsExperiment;
	CMScPhysicsExperiment*					m_pMScPhysicsExperiment;
	...
	CAddinSimulationManager(CMySimulationAddin* pAddin);
	virtual ~CAddinSimulationManager();
	void LoadExperiments(CString ExperimentType);
