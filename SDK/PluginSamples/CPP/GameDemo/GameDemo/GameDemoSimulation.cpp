...
BOOL CGameDemoSimulation::LoadLongResource(CString &str, UINT nID)
{
	try
	{
		HRSRC               hRes;
...
STDMETHODIMP CGameDemoSimulation::InvokePreferenceSettings()
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState());

	AfxMessageBox(_T("CGameDemoSimulation::InvokePreferenceSettings()"));

	return S_OK;
}


STDMETHODIMP CGameDemoSimulation::InvokeDefaultSettings()
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState());

	AfxMessageBox(_T("CGameDemoSimulation::InvokeDefaultSettings(Hai)"));

	return S_OK;
}


STDMETHODIMP CGameDemoSimulation::InvokeOnExperimentChanged()
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState());
	return S_OK;
...
void CGameDemoSimulation::SetRibbonControlText(CString ID, CString Text)
{
...
void CGameDemoSimulation::LoadAddinName(CString strXML)
{
	try
	{
		USES_CONVERSION;
