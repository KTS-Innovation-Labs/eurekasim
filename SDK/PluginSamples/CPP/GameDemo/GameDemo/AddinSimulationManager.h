...
#define CPP_SAMPLE_MAIN_EXPERIMENT_NAME								_T("GameDemo Experiment Simulation Demo")
...
public:
	...
	CAddinSimulationManager(CGameDemoSimulation* pAddin);
