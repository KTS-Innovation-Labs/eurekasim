...
class ATL_NO_VTABLE CGameDemoSimulation :
	public CComObjectRootEx<CComSingleThreadModel>,
	public CComCoClass<CGameDemoSimulation, &CLSID_GameDemoSimulation>,
	public IDispatchImpl<IGameDemoSimulation, &IID_IGameDemoSimulation, &LIBID_GameDemoLib, /*wMajor =*/ 1, /*wMinor =*/ 0>,
...
public:
	...
	BEGIN_COM_MAP(CGameDemoSimulation)
		COM_INTERFACE_ENTRY(IGameDemoSimulation)
		COM_INTERFACE_ENTRY2(IDispatch, IGameDemoSimulation)
...
OBJECT_ENTRY_AUTO(__uuidof(GameDemoSimulation), CGameDemoSimulation)
