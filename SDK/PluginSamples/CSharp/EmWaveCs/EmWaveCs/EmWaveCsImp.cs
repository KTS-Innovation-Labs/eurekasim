...
namespace EmWaveCs
{
    ...
    [Guid("be0a6181-f876-4654-89df-a0b9c8048b21")]

    public class EmWaveCsImp : EurekaSim.Net.Addin,
        ...
        IFileSettingsTreeViewEvents
    {
        ...
        public void Initialize(int lSessionID, MainApplication pApp, object bFirstTime)
        {
            ...
            Stream rgbxml = thisAssembly.GetManifestResourceStream("EmWaveCs.AddinRibbon.xml");

            Stream rgbBmp = thisAssembly.GetManifestResourceStream("EmWaveCs.toolbar1.bmp");
