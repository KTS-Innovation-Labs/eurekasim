...
namespace GameDemoCS
{
    ...
    [Guid("c8cbcfe3-03b2-4df5-9054-4b9297b3521f")]

    public class GameDemoCSImp : EurekaSim.Net.Addin,
        ...
        IFileSettingsTreeViewEvents
    {
        ...
        public void Initialize(int lSessionID, MainApplication pApp, object bFirstTime)
        {
            ...
            Stream rgbxml = thisAssembly.GetManifestResourceStream("GameDemoCS.AddinRibbon.xml");

            Stream rgbBmp = thisAssembly.GetManifestResourceStream("GameDemoCS.toolbar1.bmp");
