...
namespace StarDemoCS
{
    ...
    [Guid("bcd5a04d-ad6c-4a5a-867c-065011bbd5ae")]

    public class StarDemoCSImp : EurekaSim.Net.Addin,
        ...
        IFileSettingsTreeViewEvents
    {
        ...
        public void Initialize(int lSessionID, MainApplication pApp, object bFirstTime)
        {
            ...
            Stream rgbxml = thisAssembly.GetManifestResourceStream("StarDemoCS.AddinRibbon.xml");

            Stream rgbBmp = thisAssembly.GetManifestResourceStream("StarDemoCS.toolbar1.bmp");
