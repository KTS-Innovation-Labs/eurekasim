...
namespace StarDemoCS
{
    ...
    static class Constants
    {
        ...
        public const string CS_SAMPLE_MAIN_EXPERIMENT_NAME = "StarDemoCS Experiment Simulation Demo";
    ...
    public class CObjectPattern
    {
        ...
        public Color m_UserSelectedColor = new Color();
        public string m_strAvailablePatterns;
    ...
    public class ObjectDemoExperiment
    {
        ...
        public void ShowObjectProperties()
        {
            ...
            try
            {
                ...
                {
                    m_ObjectPattern.m_strAvailablePatterns = "Rotate,Random Movement";
                }
                else if (m_ObjectPattern.m_strObjectType == Constants.OBJECT_TYPE_STAR)
                {
                    m_ObjectPattern.m_strAvailablePatterns = "Rotate,Random Movement,Glow";
                }

                objPropertyWindow.AddPropertyItemsAsString(strGroupName, Constants.OBJECT_SIMULATION_PATTERN_TITLE, m_ObjectPattern.m_strAvailablePatterns, m_ObjectPattern.m_strSimulationPattern, "Select the Simulation Pattern", Constants.FALSE);
        ...
        public void DrawStar()
        {
            ...
            openGLView.glBegin(Constants.GL_POLYGON);                    //back pentagon face of star
            ...
            openGLView.glBegin(Constants.GL_POLYGON);                    //front pentagon face of star
            ...
            openGLView.glBegin(Constants.GL_TRIANGLES);                      //top left vertex of star
            openGLView.glVertex3f(0.0f, 0.4f, 0.4703f);
            openGLView.glVertex3f(-0.3804f, 0.1236f, 0.4703f);
            ...
            openGLView.glBegin(Constants.GL_TRIANGLES);                      //bottom right vertex of star
            openGLView.glVertex3f(0.3804f, 0.1236f, 0.4703f);
            openGLView.glVertex3f(0.2351f, -0.3236f, 0.4703f);
            ...
            openGLView.glBegin(Constants.GL_TRIANGLES);                          //bottom left vertex of star
            openGLView.glVertex3f(-0.3804f, 0.1236f, 0.4703f);
            openGLView.glVertex3f(-0.2351f, -0.3236f, 0.4703f);
            ...
            openGLView.glBegin(Constants.GL_TRIANGLES);                          //bottom most vertex of star
            openGLView.glVertex3f(0.2351f, -0.3236f, 0.4703f);
            openGLView.glVertex3f(-0.2351f, -0.3236f, 0.4703f);
            ...
            openGLView.glBegin(Constants.GL_LINE_LOOP);                  //border of back pentagon face
            openGLView.glVertex3f(0.0f, 0.4f, 0.0f);
            openGLView.glVertex3f(0.3804f, 0.1236f, 0.0f);
            openGLView.glVertex3f(0.2351f, -0.3236f, 0.0f);
            openGLView.glVertex3f(-0.2351f, -0.3236f, 0.0f);
            ...
            openGLView.glBegin(Constants.GL_LINE_LOOP);                  //border of front pentagon face
            openGLView.glVertex3f(0.0f, 0.4f, 0.4703f);
            openGLView.glVertex3f(0.3804f, 0.1236f, 0.4703f);
            openGLView.glVertex3f(0.2351f, -0.3236f, 0.4703f);
            openGLView.glVertex3f(-0.2351f, -0.3236f, 0.4703f);
            ...
            openGLView.glBegin(Constants.GL_LINE_LOOP);                      //border of top right vertex
            openGLView.glVertex3f(0.0f, 0.4f, 0.4703f);
            openGLView.glVertex3f(0.3804f, 0.1236f, 0.4703f);
            openGLView.glVertex3f(0.3654f, 0.5626f, 0.2351f);
            openGLView.glEnd();
            ...
            openGLView.glBegin(Constants.GL_LINE_LOOP);                      //border of top left vertex
            openGLView.glVertex3f(0.0f, 0.4f, 0.4703f);
            openGLView.glVertex3f(-0.3804f, 0.1236f, 0.4703f);
            openGLView.glVertex3f(-0.3654f, 0.5626f, 0.2351f);
            openGLView.glEnd();
            ...
            openGLView.glBegin(Constants.GL_LINE_LOOP);                          //border of bottom right vertex
            openGLView.glVertex3f(0.3804f, 0.1236f, 0.4703f);
            openGLView.glVertex3f(0.2351f, -0.3236f, 0.4703f);
            openGLView.glVertex3f(0.6951f, -0.2259f, 0.2351f);
            openGLView.glEnd();
            ...
            openGLView.glBegin(Constants.GL_LINE_LOOP);                          //border of bottom left vertex
            openGLView.glVertex3f(-0.3804f, 0.1236f, 0.4703f);
            openGLView.glVertex3f(-0.2351f, -0.3236f, 0.4703f);
            openGLView.glVertex3f(-0.6951f, -0.2259f, 0.2351f);
            openGLView.glEnd();
            ...
            openGLView.glBegin(Constants.GL_LINE_LOOP);                          //border of bottom most vertex
            openGLView.glVertex3f(0.2351f, -0.3236f, 0.4703f);
            openGLView.glVertex3f(-0.2351f, -0.3236f, 0.4703f);
            openGLView.glVertex3f(0.0f, -0.7309f, 0.2351f);
            openGLView.glEnd();
    ...
    public void StartSimulation(string ExperimentGroup, string ExperimentName)
        ...
        public void StartObjectSimulation()
        {
            ...
            while (m_pManager.m_bSimulationActive)
            {
                ...
                if (m_ObjectPattern.m_strSimulationPattern != Constants.OBJECT_PATTERN_TYPE_GLOW)
                {
